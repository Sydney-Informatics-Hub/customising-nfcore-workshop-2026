...
Given that the error is *intermittent*, we would like to **verify at the code level** that the fix has been applied to our test mice samples before we run it on the other 998... 
