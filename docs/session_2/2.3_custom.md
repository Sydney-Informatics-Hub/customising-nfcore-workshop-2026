...
!!! example "Exercise 2.3.4.2.2 :stopwatch: 3 mins"
    ...
    - Using the procedure described in [Exercise 2.2.2.3](2.2_config.md/#2223-discovering-default-process-settings), find the `main.nf` file for the HISAT2_ALIGN process:
    ...
    - Open the file with `code rnaseq/modules/nf-core/hisat2/align/main.nf` file
...
!!! example "Exercise 2.3.4.5.1 :stopwatch: 5 mins"
    ...
    ??? hint
        ...
        Recall from [Lesson 2.1.6.2](2.1_params.md/#2163-software-versions) that all tool versions are included within the MultiQC report as well as a yaml file in the `pipeline_info` folder. 
