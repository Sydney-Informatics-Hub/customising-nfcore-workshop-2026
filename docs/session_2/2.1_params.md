...
The first is the MultiQC report, which we viewed in [Lesson 2.1.4](#214-resolve-a-pipeline-warning-with-a-parameter). If you still have this file open, scroll to the end of the report or use the heading links on the left hand side of the report: 
...
- Double click `lesson-2.1.5/pipeline_info/nf_core_rnaseq_software_mqc_versions.yml` to view software versions 
