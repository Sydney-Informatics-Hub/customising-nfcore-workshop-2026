...
!!! example "Exercise 1.4.1"
    ...
    - Downloads the necessary Singularity containers 
...
!!! example "List the downloaded directory contents"
    ...
    total 340
    drwxrwxr-x 2 tdev01 tdev01   4096 Apr 16 03:31 assets
    drwxrwxr-x 2 tdev01 tdev01   4096 Apr 16 03:31 bin
    -rwxrwxr-x 1 tdev01 tdev01 114722 Apr 16 03:31 CHANGELOG.md
    -rwxrwxr-x 1 tdev01 tdev01  10707 Apr 16 03:31 CITATIONS.md
    -rwxrwxr-x 1 tdev01 tdev01  13562 Apr 16 03:31 CODE_OF_CONDUCT.md
    drwxrwxr-x 2 tdev01 tdev01   4096 Apr 16 03:31 conf
    drwxrwxr-x 5 tdev01 tdev01   4096 Apr 16 03:31 docs
    -rwxrwxr-x 1 tdev01 tdev01   1075 Apr 16 03:31 LICENSE
    -rwxrwxr-x 1 tdev01 tdev01   7078 Apr 16 03:31 main.nf
    drwxrwxr-x 4 tdev01 tdev01   4096 Apr 16 03:31 modules
    -rwxrwxr-x 1 tdev01 tdev01  24049 Apr 16 03:31 modules.json
    -rwxrwxr-x 1 tdev01 tdev01  16881 Apr 16 03:31 nextflow.config
    -rwxrwxr-x 1 tdev01 tdev01  57843 Apr 16 03:31 nextflow_schema.json
    -rwxrwxr-x 1 tdev01 tdev01   1507 Apr 16 03:31 nf-test.config
    -rwxrwxr-x 1 tdev01 tdev01  13027 Apr 16 03:31 README.md
    -rwxrwxr-x 1 tdev01 tdev01  23008 Apr 16 03:31 ro-crate-metadata.json
    drwxrwxr-x 4 tdev01 tdev01   4096 Apr 16 03:31 subworkflows
    drwxrwxr-x 2 tdev01 tdev01   4096 Apr 16 03:31 tests
    -rwxrwxr-x 1 tdev01 tdev01   3014 Apr 16 03:31 tower.yml
    drwxrwxr-x 3 tdev01 tdev01   4096 Apr 16 03:31 workflows

    nf-core-rnaseq-3.23.0/configs:
    total 68
    drwxrwxr-x 2 tdev01 tdev01  4096 Apr 16 03:31 bin
    -rwxrwxr-x 1 tdev01 tdev01  1562 Apr 16 03:31 CITATION.cff
    drwxrwxr-x 5 tdev01 tdev01  4096 Apr 16 03:31 conf
    -rwxrwxr-x 1 tdev01 tdev01   273 Apr 16 03:31 configtest.nf
    drwxrwxr-x 4 tdev01 tdev01  4096 Apr 16 03:31 docs
    -rwxrwxr-x 1 tdev01 tdev01  1064 Apr 16 03:31 LICENSE
    -rwxrwxr-x 1 tdev01 tdev01    69 Apr 16 03:31 nextflow.config
    -rwxrwxr-x 1 tdev01 tdev01 15008 Apr 16 03:31 nfcore_custom.config
    drwxrwxr-x 2 tdev01 tdev01  4096 Apr 16 03:31 pipeline
    -rwxrwxr-x 1 tdev01 tdev01 16892 Apr 16 03:31 README.md
    ```
...
The pipeline requires us to define both an input samplesheet and an output directory to place our results. We supply these with the `--input` and `--outdir` parameters, respectively. We've already looked at our input samplesheet: `/home/training/data/samplesheet.csv`. Our output directory can be named anything we want, and will be automatically created by Nextflow if it doesn't already exists.
...
!!! example "Exercise 1.4.2.1"
    ...
    ??? success "Solution"
        ...
        **Note** that we have added a space and a backslash (` \`) to the end of the line so we may continue writing the full command over multiple lines for legibility.
        ...
        nextflow run nf-core-rnaseq-3.23.0/3_23_0 \
            --input /home/training/data/samplesheet.csv \
        ```
...
|----------------|-----------|
| FASTA          | `/home/training/data/mm10_reference/mm10_chr18.fa` |
| GTF            | `/home/training/data/mm10_reference/mm10_chr18.gtf` |
| STAR index     | `/home/training/data/mm10_reference/STAR` |
| Salmon index   | `/home/training/data/mm10_reference/salmon-index` |
...
!!! example "Exercise 1.4.2.2"
    ...
    ??? success "Solution"
        ...
        nextflow run nf-core-rnaseq-3.23.0/3_23_0 \
            ...
            --fasta /home/training/data/mm10_reference/mm10_chr18.fa \
            --gtf /home/training/data/mm10_reference/mm10_chr18.gtf \
            --star_index /home/training/data/mm10_reference/STAR \
            --salmon_index /home/training/data/mm10_reference/salmon-index \
        ```
...
!!! example "Exercise 1.4.2.4"
    ...
    Create a file called `nextflow.config` within your current working directory (`/home/training/session2`) and add the `resourceLimits` directive, giving our workflow a limit of 2 CPUs and 6GB of memory.
...
drwxrwxr-x   7 training training 4.0K Apr 21 03:58 Lesson-1.4
...
:eyes: Nextflow has created 2 new output directories, **work** and **Lesson-1.4** in the current directory. 
