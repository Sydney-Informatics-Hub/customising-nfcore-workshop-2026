...
### :construction: TODO: Moving to 1.1 :construction:
...
[![](../assets/1.3_params.excalidraw.png){width=80%}](https://nf-co.re/rnaseq/3.11.1/parameters)
...
!!! tip
    ...
    Pawsey has a [shared profile](https://github.com/nf-core/configs/blob/master/docs/pawsey_nimbus.md) that can be used to run workflows.
